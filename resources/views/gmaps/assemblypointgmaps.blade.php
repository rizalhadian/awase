...
<script
    src="https://maps.googleapis.com/maps/api/js?key=AIzaSyDBBOgKB1pZrlZRklVCKjUNGpcUiUy1s3M" async defer>
</script>
<script
                ...
                google.maps.event.addListener(marker, 'click', function(event){
                  ...
                  $.ajax({
                     ...
                     success: function (data){
                       infoWind.setContent(
                         "<h4>" + data[0].name + "</h4><br>" +
                         "<h6>Alamat : " + data[0].address + "</h6><br>" +
                         "<center>" +
                         "<button type='button' class='btn btn-info btn-xs' id='getDetail'>Detail / Edit</button>" +" "+
                         "<button type='button' class='btn btn-danger btn-xs' id='confDelete'>Delete</button>" +
                         "</center>"
                       ), 'json';
